...
# Time pooling factor (reduce sequence length)
# (larger -> fewer time steps -> faster; 10 is a good compromise)
TIME_POOL = 10
...
class MelTransformerDataset(Dataset):
    ...
    def __init__(self, file_pairs, time_pool=10):
        ...
        print(f"[INFO] Total female segments: {total}")
    ...
    def __getitem__(self, idx):
        ...
        seq = self._segment_to_sequence(X_np)         # (T', feat_dim)
