...
OUTPUT_DIR="/scratch/sshuvo13/project_shared_folder_bspml_1/segments_30s/features/female/fraction_low_energy_windows"
...
# ==============================================================================
PYTHON_SCRIPT="./fr_low_en_win_sbatch_framework_full_dataset.py"
